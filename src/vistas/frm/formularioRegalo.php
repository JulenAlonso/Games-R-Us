      ...
      <div class="div1">
        <form action="" method="POST" id="gift-form">
          <fieldset>
            ...
            <div class="inputBox">
              <textarea name="gift_message" id="gift_message" class="inputUser"
                placeholder="Escribe un mensaje para el destinatario" required></textarea>
            ...
            <div class="inputBox">
              ...
              <textarea name="product_list" id="product_list" class="inputUser" rows="4"
                placeholder="Escribe los productos que deseas regalar, separados por comas" required></textarea>
            </div><br><br>
          </fieldset>
        </form>
      </div>
